...
int main(){
 ...
 // read data from file
 constexpr auto filename = "driftdiffusion.json";
 ...
 p2gd_step2 Jdiff_x(p.device_x.cbegin(), p.device_y.cbegin(), thrust::raw_pointer_cast(p.device_grid_M.data()),
   ...
   qg.hy(), 1e-6,  p.device_dprops["M"].cbegin(), p.device_dprops["zero"].cbegin(), false);
 ...
 p2gd_step2 Jdiff_y(p.device_x.cbegin(), p.device_y.cbegin(), thrust::raw_pointer_cast(p.device_grid_M.data()),
   ...
   qg.hy(), 1e-6,  p.device_dprops["zero"].cbegin(), p.device_dprops["M"].cbegin(), false); 
 ...
 stepper step(p.device_x.begin(), p.device_y.begin(), p.device_dprops["VX"].begin(), p.device_dprops["VY"].begin(), 1.);
